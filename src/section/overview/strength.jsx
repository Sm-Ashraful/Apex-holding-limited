export default function KeyStrength() {
    return (
        <section className="section-strength">
            ...
            <div className="row">
                <div className="col-1-of-4 u-flex"><span className="big-icon ">
                    ...
                    <h1 className="heading-tertiary">22,000+</h1>
                    <p>TOTAL EMPLOYEE</p></div>
                <div className="col-1-of-4 u-flex">
                ...
                <div className="col-1-of-4 u-flex"></div>
                <span className="big-icon ">
